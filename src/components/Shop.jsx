...
const staticProducts = [
  {
    ...
    size: '12×16 inch',
    price: '₹9,500',
    gradient: 'linear-gradient(145deg, #f5d08a, #e8956a, #c17f47)',
    sold: false,
  },
  {
    name: 'Monsoon Melody',
    ...
    size: '16×20 inch',
    price: '₹15,000',
    gradient: 'linear-gradient(145deg, #8ec9d0, #5a9eb8, #3d6e8a)',
    sold: false,
  },
  {
    name: 'Temple Bells',
    ...
    size: '18×24 inch',
    price: '₹22,000',
    gradient: 'linear-gradient(145deg, #e87878, #c04848, #8a2828)',
    sold: true,
  },
  {
    name: 'Evening Raga',
    ...
    size: '10×14 inch',
    price: '₹7,000',
    gradient: 'linear-gradient(145deg, #c0a8d8, #9070b8, #604888)',
    sold: false,
  },
];
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        borderRadius: 20,
        overflow: 'hidden',
        boxShadow: hovered ? '0 20px 50px rgba(193,127,71,0.2)' : '0 4px 20px rgba(44,24,16,0.08)',
    ...
    >
      ...
      {product.sold && (
        <div style={{ position: 'absolute', inset: 0, backgroundColor: 'rgba(253,248,243,0.75)', zIndex: 10, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ backgroundColor: '#2c1810', color: '#fdf8f3', padding: '10px 24px', borderRadius: 4, fontFamily: "'Jost', sans-serif", fontWeight: 700, fontSize: '0.9rem', letterSpacing: '0.15em', textTransform: 'uppercase', transform: 'rotate(-15deg)' }}>
            Sold Out
          </div>
        </div>
      )}
      ...
      <div style={{ height: 200, position: 'relative', overflow: 'hidden', backgroundColor: '#f5e6d3' }}>
        ...
        {product.image ? (
          ...
          <motion.div
            animate={{ scale: hovered ? 1.06 : 1 }}
            transition={{ duration: 0.5 }}
            style={{ width: '100%', height: '100%', background: product.gradient }}
          />
        )}
        {/* Certificate badge */}
        <div style={{
      ...
      <div style={{ padding: '18px 18px 22px' }}>
        ...
        <p style={{ fontFamily: "'Jost', sans-serif", fontSize: '0.82rem', color: '#8a7060', marginBottom: '1rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              fontSize: '0.85rem',
              backgroundColor: product.sold ? '#e0d4c8' : '#c17f47',
              color: '#fff',
              border: 'none',
              borderRadius: '50px',
              padding: '10px 20px',
              cursor: product.sold ? 'not-allowed' : 'pointer',
              letterSpacing: '0.04em',
              transition: 'background-color 0.3s',
            }}
            onMouseEnter={(e) => { if (!product.sold) e.currentTarget.style.backgroundColor = '#8b5e3c'; }}
            onMouseLeave={(e) => { if (!product.sold) e.currentTarget.style.backgroundColor = '#c17f47'; }}
          >
...
export default function Shop() {
    ...
    (async () => {
      ...
      if (!error && data && data.length > 0) {
        setProducts(data.map(p => ({
          ...
          price: p.price,
          image: p.image_url,
          gradient: 'linear-gradient(145deg, #f5c9a0, #e8956a)',
          sold: p.is_sold,
        })));
      }
    })();
  ...
  return (
    <section id="shop" ref={ref} style={{ backgroundColor: '#fdf8f3', padding: '100px 0', position: 'relative', overflow: 'hidden' }}>
      {/* Background blob */}
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div
          ...
          style={{
            ...
            padding: '36px 40px',
            textAlign: 'center',
            boxShadow: '0 6px 30px rgba(193,127,71,0.08)',
            position: 'relative',
            overflow: 'hidden',
          }}
        >
          ...
          <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.5rem', fontWeight: 700, color: '#2c1810', marginBottom: '0.75rem' }}>
          ...
          <p style={{ fontFamily: "'Jost', sans-serif", fontSize: '1rem', color: '#8a7060', marginBottom: '1.5rem', maxWidth: 500, margin: '0 auto 1.5rem' }}>
            Have a vision in mind? I'd love to create a one-of-a-kind painting just for you. Contact us to discuss your idea, size, and budget.
          </p>
          <button
            style={{
              fontFamily: "'Jost', sans-serif",
              ...
              boxShadow: '0 6px 22px rgba(193,127,71,0.35)',
              transition: 'all 0.3s',
            }}
